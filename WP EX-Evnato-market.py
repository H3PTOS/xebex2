...
[#] Create By ::
	  ___                                                    ______        
 _    _ __     ______ _____  ______  _______ 
\ \  / / /    / _____/ ___ \(_____ \(_______)
 \ \/ / /____| /    | |   | |_____) )_____   
  )  |___   _| |    | |   | (_____ (|  ___)  
 / /\ \  | | | \____| |___| |     | | |_____ 
/_/  \_\ |_|  \______\_____/      |_|_______)
                                             

          ############## perv exploit joomla ##############                                                                     		 
	    Telegram Channels => https://t.me/x4coreseller			   
\n'''.format(fr)
print banner
...
Pathlist = ['/wp-content/plugins/envato-market/inc/class-envato-market-api.php']
